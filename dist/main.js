...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ NewTodo),\n/* harmony export */   \"deleteCompletedTodos\": () => (/* binding */ deleteCompletedTodos),\n/* harmony export */   \"deleteTodo\": () => (/* binding */ deleteTodo),\n/* harmony export */   \"idReset\": () => (/* binding */ idReset),\n/* harmony export */   \"selectTodo\": () => (/* binding */ selectTodo),\n/* harmony export */   \"updateTodo\": () => (/* binding */ updateTodo)\n/* harmony export */ });\n/* harmony import */ var _create_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create.js */ \"./modules/create.js\");\n/* harmony import */ var _src_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/index.js */ \"./src/index.js\");\n\n\n\n// logic to create new todo using javascript class\nclass NewTodo {\n  constructor(description) {\n    this.description = description;\n    this.id = _src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoListss.length + 1;\n  }\n\n  add = () => {\n    const item = {\n      id: this.id,\n      description: this.description,\n      completed: false,\n      disabled: true,\n      icon: 'more_vert',\n    };\n    (0,_create_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(item);\n    _src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoListss.push(item);\n  };\n}\n\n// reset todo id\nconst idReset = (lists) => {\n  lists.forEach((todo, ind) => {\n    todo.id = ind + 1;\n  });\n};\n\n// logic to delete all completed todos\nconst deleteCompletedTodos = () => {\n  const newTodos = _src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoListss.filter((item, ind) => item.completed !== true);\n  idReset(newTodos);\n  localStorage.setItem('todos', JSON.stringify(newTodos));\n  window.location.reload();\n};\n\n// logic to delete a single todo\nconst deleteTodo = (id, itemContainer, cont) => {\n  const newTodos = _src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoListss.filter((item, ind) => item.id !== id);\n  localStorage.setItem('todos', JSON.stringify(newTodos));\n  console.log(_src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoUl.removeChild(itemContainer));\n  _src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoUl.removeChild(itemContainer);\n};\n\n// logic to update the the description of a todo\nconst updateTodo = (input, id, itemForm, option) => {\n  input.disabled = false;\n  input.focus();\n\n  _src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoListss.forEach((todo) => {\n    todo.icon = 'more_vert';\n    if (todo.id === id) {\n      todo.disabled = false;\n      if (todo.disabled === false) {\n        todo.icon = 'delete';\n        option.innerText = todo.icon;\n\n        option.style.cursor = 'pointer';\n        itemForm.addEventListener('submit', (e) => {\n          e.preventDefault();\n          todo.description = input.value;\n          localStorage.setItem('todos', JSON.stringify(_src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoListss));\n          input.disabled = true;\n        });\n      }\n    } else {\n      todo.disabled = true;\n    }\n  });\n  _src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoUl.innerHTML = '';\n  (0,_src_index_js__WEBPACK_IMPORTED_MODULE_1__.displayTodos)(_src_index_js__WEBPACK_IMPORTED_MODULE_1__.todoListss);\n};\n\n// functionality to mark a todo as completed\nconst selectTodo = (checkBox, todoTitle, item) => {\n  if (checkBox.checked) {\n    todoTitle.style.textDecoration = 'line-through';\n    item.completed = true;\n  } else {\n    todoTitle.style.textDecoration = 'none';\n    item.completed = false;\n  }\n};\n\n\n//# sourceURL=webpack://todolist-project/./modules/crud.js?");
